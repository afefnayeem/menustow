...
struct PermissionsView: View {
    ...
    private var explanationBox: some View {
        MenustowSection {
            VStack {
                Text("menustow needs your permission to manage the menu bar.")
                    .fontWeight(.medium)
        ...
        MenustowSection {
            VStack(spacing: 12) {
                ...
                if !permission.isRequired {
                    CalloutBox("menustow can work in a limited mode without this permission.") {
