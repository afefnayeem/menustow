...
struct MenuBarAppearanceConfigurationV1: Hashable {
    ...
    var tintGradient: MenustowGradient
    ...
    static func migrate(encoder: JSONEncoder, decoder: JSONDecoder) throws -> Self {
        ...
        if let data = Defaults.data(forKey: .menuBarAppearanceConfiguration) {
            ...
            if let borderColorData = Defaults.data(forKey: .menuBarBorderColor) {
                configuration.borderColor = try decoder.decode(MenustowColor.self, from: borderColorData).cgColor
            }
            if let tintColorData = Defaults.data(forKey: .menuBarTintColor) {
                configuration.tintColor = try decoder.decode(MenustowColor.self, from: tintColorData).cgColor
            }
            if let tintGradientData = Defaults.data(forKey: .menuBarTintGradient) {
                configuration.tintGradient = try decoder.decode(MenustowGradient.self, from: tintGradientData)
            }
...
extension MenuBarAppearanceConfigurationV1: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        try self.init(
            ...
            borderColor: container.decodeIfPresent(MenustowColor.self, forKey: .borderColor)?.cgColor ?? Self.defaultConfiguration.borderColor,
            ...
            tintColor: container.decodeIfPresent(MenustowColor.self, forKey: .tintColor)?.cgColor ?? Self.defaultConfiguration.tintColor,
            tintGradient: container.decodeIfPresent(MenustowGradient.self, forKey: .tintGradient) ?? Self.defaultConfiguration.tintGradient
        )
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(MenustowColor(cgColor: borderColor), forKey: .borderColor)
        ...
        try container.encode(MenustowColor(cgColor: tintColor), forKey: .tintColor)
