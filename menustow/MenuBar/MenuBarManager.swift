...
final class MenuBarManager: ObservableObject {
    ...
    /// The panel that contains the menustow Bar interface.
    let menustowBarPanel = MenustowBarPanel()
    ...
    func performSetup(with appState: AppState) {
        ...
        menustowBarPanel.performSetup(with: appState)
