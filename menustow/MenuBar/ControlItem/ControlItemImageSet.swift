...
struct ControlItemImageSet: Codable, Hashable, Identifiable {
    enum Name: String, Codable, Hashable {
        ...
        case menustowMark = "Menustow Mark"
...
extension ControlItemImageSet {
    /// The default image set for the menustow icon.
    static let defaultMenustowIcon = ControlItemImageSet(
        name: .dot,
        hidden: .catalog("DotFill"),
        visible: .catalog("DotStroke")
    )

    /// The image sets that the user can choose to display in the menustow icon.
    static let userSelectableMenustowIcons = [
        ControlItemImageSet(
            name: .arrow,
        ...
        ControlItemImageSet(
            name: .menustowMark,
            hidden: .catalog("MenustowMarkStroke"),
            visible: .catalog("MenustowMarkFill")
        ),
        ControlItemImageSet(
            name: .sunglasses,
