...
final class ControlItem {
    ...
    enum Identifier: String, CaseIterable {
        ...
        case visible = "menustow.ControlItem.Visible"
        /// The identifier for the control item for the hidden section.
        case hidden = "menustow.ControlItem.Hidden"
        /// The identifier for the control item for the always-hidden section.
        case alwaysHidden = "menustow.ControlItem.AlwaysHidden"
    ...
    private func configureCancellables() {
        ...
        if let appState {
            ...
            if identifier == .visible {
                appState.settings.general.$showMenustowIcon
                ...
                appState.settings.general.$menustowIcon
                    .combineLatest(appState.settings.general.$customMenustowIconIsTemplate)
                    .removeDuplicates()
                    .receive(on: DispatchQueue.main)
                    .sink { [weak self] _ in
                        self?.updateStatusItem()
    ...
    private func updateStatusItem() {
        ...
        case .visible:
            ...
            let icon = appState.settings.general.menustowIcon
    ...
    private func createMenu(with appState: AppState) -> NSMenu {
        ...
        let menu = NSMenu(title: "menustow")

        let settingsItem = NSMenuItem(
            title: "menustow Settings…",
