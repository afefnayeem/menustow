...
final class AppState: ObservableObject {
    ...
    private func configureCancellables() {
        ...
        hidEventManager.$isDraggingMenuBarItem
            ...
            .sink { [weak self] _ in
                ...
                Task {
                    await self.itemManager.cacheItemsRegardless(bypassMoveBuffer: true)
    ...
    func hasPermission(_ key: AppPermissions.PermissionKey) -> Bool {
        ...
        case .inputMonitoring:
            permissions.inputMonitoring.hasPermission
        case .postEvents:
            permissions.postEvents.hasPermission
    ...
    func publisherForWindow(_ id: MenustowWindowIdentifier) -> some Publisher<NSWindow?, Never> {
    ...
    func openWindow(_ id: MenustowWindowIdentifier) {
    ...
    func dismissWindow(_ id: MenustowWindowIdentifier) {
        // Async prevents conflicts with SwiftUI.
        DispatchQueue.main.async {
