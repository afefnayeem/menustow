...
struct AdvancedSettingsPane: View {
    ...
    var body: some View {
        MenustowForm {
            MenustowSection("Menu Bar Sections") {
                enableAlwaysHiddenSection
                showAllSectionsOnUserDrag
                sectionDividerStyle
            }
            MenustowSection("Other") {
                hideApplicationMenus
                enableSecondaryContextMenu
                showOnHoverDelay
                tempShowInterval
            }
            MenustowSection("Permissions") {
                allPermissions
            }
        }
    }
    ...
    private var sectionDividerStyle: some View {
        MenustowPicker("Section divider style", selection: $settings.sectionDividerStyle) {
    ...
    private var hideApplicationMenus: some View {
        ...
        .annotation {
            Text(
                ...
                needed. macOS requires menustow to make itself visible in the Dock while \
    ...
    private var enableSecondaryContextMenu: some View {
        ...
        .annotation {
            Text(
                ...
                version of menustow's menu. Disable this setting if you encounter conflicts \
                with other apps.
                """
            )
            .padding(.trailing, 75)
