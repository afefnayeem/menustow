...
struct MenustowGradientPicker<Label: View>: View {
    @Binding private var gradient: MenustowGradient
    ...
    init(
        gradient: Binding<MenustowGradient>,
...
private struct MenustowGradientPickerRoot: View {
    @Environment(\.isEnabled) private var isEnabled

    @Binding var gradient: MenustowGradient
    ...
    private func gradientChanged(from oldValue: MenustowGradient, to newValue: MenustowGradient) {
...
private struct MenustowGradientPickerHandle: View {
    @Binding var gradient: MenustowGradient
    @Binding var selection: Int?
    ...
    private var stop: MenustowGradient.ColorStop? {
