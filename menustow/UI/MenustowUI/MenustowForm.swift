...
struct MenustowForm<Content: View>: View {
    ...
    private var contentLayout: some View {
        VStack(alignment: alignment, spacing: spacing) {
            content
                .labeledContentStyle(MenustowFormLabeledContentStyle())
                .toggleStyle(MenustowFormToggleStyle())
        }
        .padding(padding)
...
private struct MenustowFormLabeledContentStyle: LabeledContentStyle {
...
private struct MenustowFormToggleStyle: ToggleStyle {
    func makeBody(configuration: Configuration) -> some View {
...
extension EdgeInsets {
    /// The default padding for an ``MenustowForm``.
...
extension CGFloat {
    /// The default spacing for an ``MenustowForm``.
